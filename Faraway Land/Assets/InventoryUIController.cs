...
public class InventoryUIController : MonoBehaviour
{
    ...
    public void LoadItems() // Chamado toda vez que o inventario abre
    {
    ...
    private void ChangeSelection(int increment)
    {
        ...
        if (increment == 1 && this._selectedSlot % 5 == 0)
        {
            this._selectedSlot -= 5;
            this.ChangePage(+1);
        }

        if (increment == -1 && (this._selectedSlot + 1) % 5 == 0)
        {
            this._selectedSlot += 5;
            this.ChangePage(-1);
        }
        ...
        {
            this._selectedSlot += this._slots.Length;
        }
    ...
    private void UpdateSlots()
    {
        ...
        while (slotIndex < this._slots.Length)
        {
            ...
            bool flag = itemIndex < this._currentInventoryContents.Length;
            if (flag)
            {
