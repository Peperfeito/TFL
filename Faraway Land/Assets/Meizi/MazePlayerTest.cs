...
//        // Smooth Movement
//        if (Input.GetKeyDown(KeyCode.W) && this._positionTimer >= 1)
//        {
...
//            }
//        }
//        if (Input.GetKeyDown(KeyCode.A) && this._rotationTimer >= 1)
//        {
//            Vector3 rot = this.transform.rotation.eulerAngles;
//            rot.y += 270f;
//            this._targetRotation = Quaternion.Euler(rot);
...
//        }
//        if (Input.GetKeyDown(KeyCode.D) && this._rotationTimer >= 1)
//        {
//            Vector3 rot = this.transform.rotation.eulerAngles;
//            rot.y += 90f;
//            this._targetRotation = Quaternion.Euler(rot);
//            this._rotationTimer = 0f;
//        }
//        if (Input.GetKeyDown(KeyCode.S) && this._rotationTimer >= 1)
//        {
//            Vector3 rot = this.transform.rotation.eulerAngles;
//            rot.y += 180f;
//            this._targetRotation = Quaternion.Euler(rot);
